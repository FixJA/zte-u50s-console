export function openConfirmDialog({ state, els, endpoint, token, successMessage, title, details, thermalTarget, onSuccess }) {
  ...
  if (onSuccess) state.pendingAction.onSuccess = onSuccess;
